    ...
    <section class="playlist">
        ...
        <div class="box-container">
            ...
            ?>
                    ...
                    <div class="box">
                        <?php if ($fetch_song['album'] != '') { ?>
                            ...
                            <img src="uploaded-album/<?= $fetch_song['album']; ?>" alt="" class="album">
                        ...
                        <div class="flex">
                            <div class="play" data-src="uploaded-music/<?= $fetch_song['music']; ?>"><i class="fas fa-play"></i><span>play</span></div>

                            <a href="uploaded-music/<?= $fetch_song['music']; ?>" download><i class="fas fa-download"></i><span>download</span></a>
                        </div>
            ...
            <div class="box more-btn">
                <a href="upload-music.php" class="btn">upload music</a>
            </div>
        </div>
    </section>
